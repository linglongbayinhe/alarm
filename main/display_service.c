...
#define DISPLAY_WIFI_ICON_WIDTH 36
#define DISPLAY_WIFI_ICON_HEIGHT 24
#define DISPLAY_WIFI_ICON_SCALE 1
#define DISPLAY_WIFI_ICON_MARGIN_RIGHT 8
#define DISPLAY_WIFI_ICON_SCALED_WIDTH (DISPLAY_WIFI_ICON_WIDTH * DISPLAY_WIFI_ICON_SCALE)
#define DISPLAY_WIFI_ICON_SCALED_HEIGHT (DISPLAY_WIFI_ICON_HEIGHT * DISPLAY_WIFI_ICON_SCALE)
#define DISPLAY_WIFI_ICON_X (DISPLAY_WIDTH - DISPLAY_WIFI_ICON_SCALED_WIDTH - DISPLAY_WIFI_ICON_MARGIN_RIGHT)
#define DISPLAY_WIFI_ICON_Y ((DISPLAY_LINE_HEIGHT - DISPLAY_WIFI_ICON_SCALED_HEIGHT) / 2)
#define DISPLAY_WIFI_ICON_BYTES_PER_ROW ((DISPLAY_WIFI_ICON_WIDTH + 7) / 8)
#define DISPLAY_WIFI_ICON_BUFFER_SIZE (DISPLAY_WIFI_ICON_HEIGHT * DISPLAY_WIFI_ICON_BYTES_PER_ROW)
...
static const uint8_t DISPLAY_WIFI_ICON_CONNECTED_BASE[DISPLAY_WIFI_ICON_BUFFER_SIZE] = {
...
static const uint8_t DISPLAY_WIFI_ICON_LEVEL_1[DISPLAY_WIFI_ICON_BUFFER_SIZE] = {
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
...
static const uint8_t DISPLAY_WIFI_ICON_LEVEL_2[DISPLAY_WIFI_ICON_BUFFER_SIZE] = {
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
...
static const uint8_t DISPLAY_WIFI_ICON_LEVEL_3[DISPLAY_WIFI_ICON_BUFFER_SIZE] = {
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
...
static const uint8_t DISPLAY_WIFI_ICON_LEVEL_4[DISPLAY_WIFI_ICON_BUFFER_SIZE] = {
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00,
...
static const uint8_t DISPLAY_WIFI_ICON_DISCONNECTED_SLASH[DISPLAY_WIFI_ICON_BUFFER_SIZE] = {
    0x00, 0x00, 0x00, 0x00, 0x00,
...
/* Draws a 1-bit bitmap into the temporary line buffer. */
static void display_draw_mono_bitmap(const uint8_t *bitmap,
                                     int width,
                                     int height,
                                     int x_offset,
                                     int y_offset,
                                     ...
                                     uint16_t color)
{
    ...
    for (row = 0; row < height; ++row) {
        for (column = 0; column < width; ++column) {
            size_t byte_index = (size_t)(row * bytes_per_row) + (size_t)(column / 8);
            uint8_t bit_mask = (uint8_t)(0x80U >> (column % 8));
...
/* Picks the correct Wi-Fi icon for the current connection state. */
static display_bitmap_t display_select_wifi_icon(const display_view_model_t *view_model)
{
    if (!view_model->wifi_connected) {
        return (display_bitmap_t){DISPLAY_WIFI_ICON_CONNECTED_BASE,
                                  DISPLAY_WIFI_ICON_WIDTH,
                                  DISPLAY_WIFI_ICON_HEIGHT};
    }

    switch (view_model->wifi_signal_level) {
    case 1:
        return (display_bitmap_t){DISPLAY_WIFI_ICON_LEVEL_1,
                                  DISPLAY_WIFI_ICON_WIDTH,
                                  DISPLAY_WIFI_ICON_HEIGHT};
    case 2:
        return (display_bitmap_t){DISPLAY_WIFI_ICON_LEVEL_2,
                                  DISPLAY_WIFI_ICON_WIDTH,
                                  DISPLAY_WIFI_ICON_HEIGHT};
    case 3:
        return (display_bitmap_t){DISPLAY_WIFI_ICON_LEVEL_3,
                                  DISPLAY_WIFI_ICON_WIDTH,
                                  DISPLAY_WIFI_ICON_HEIGHT};
    case 4:
        return (display_bitmap_t){DISPLAY_WIFI_ICON_LEVEL_4,
                                  DISPLAY_WIFI_ICON_WIDTH,
                                  DISPLAY_WIFI_ICON_HEIGHT};
    default:
        return (display_bitmap_t){DISPLAY_WIFI_ICON_CONNECTED_BASE,
...
static esp_err_t display_render_status_icon_region(const display_view_model_t *view_model)
{
    ...
    if (view_model->wifi_icon_visible) {
        display_bitmap_t icon = display_select_wifi_icon(view_model);

        display_draw_mono_bitmap(icon.data,
                                 icon.width,
                                 icon.height,
                                 DISPLAY_WIFI_ICON_X,
                                 DISPLAY_WIFI_ICON_Y,
                                 DISPLAY_WIFI_ICON_SCALE,
                                 DISPLAY_COLOR_WHITE);

        if (!view_model->wifi_connected) {
            display_draw_mono_bitmap(DISPLAY_WIFI_ICON_DISCONNECTED_SLASH,
                                     DISPLAY_WIFI_ICON_WIDTH,
                                     DISPLAY_WIFI_ICON_HEIGHT,
                                     DISPLAY_WIFI_ICON_X,
                                     DISPLAY_WIFI_ICON_Y,
